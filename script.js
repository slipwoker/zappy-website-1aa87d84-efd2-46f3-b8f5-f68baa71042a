        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            if (isValid) {
                ...
                setTimeout(() => {
                    ...
                    successMsg.style.cssText = 'color: #28a745; padding: 1rem; background: #d4edda; border-radius: 4px; margin-top: 1rem;';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '1aa87d84-efd2-46f3-b8f5-f68baa71042a',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '1aa87d84-efd2-46f3-b8f5-f68baa71042a';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '1aa87d84-efd2-46f3-b8f5-f68baa71042a';
